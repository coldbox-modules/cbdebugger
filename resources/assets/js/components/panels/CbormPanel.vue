					...
					<template v-for="event in eventStore.filteredEvents" :key="event.EVENTID">
                      <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
						...
						<td class="w-4 px-4 py-3">{{ event.extraInfo.recordCount }}</td>
                          ...
                          <td scope="row" class="items-center px-4 py-2 font-medium text-gray-900 dark:text-white">
							<highlighted-code language="sql" :code="event.extraInfo.sql"></highlighted-code>
							<div class="database-query-bindings" v-if="event.extraInfo.params">
								<VueJsonView theme="chalk" :src="event.extraInfo.params" collapsed sortKeys />
							</div>
                          </td>
